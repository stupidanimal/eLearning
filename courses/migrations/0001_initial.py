# Generated by Django 2.0.2 on 2018-04-20 06:38
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coursename', models.CharField(max_length=50, verbose_name='课程名')),
                ('desc', models.CharField(max_length=200, verbose_name='描述信息')),
                ('detial', models.TextField(choices=[(1, '初级'), (2, '中级'), (3, '高级')], max_length=2, verbose_name='课程详情')),
                ('learn_times', models.IntegerField(default=0, verbose_name='学习时长')),
                ('students', models.IntegerField(default=0, verbose_name='收藏人数')),
